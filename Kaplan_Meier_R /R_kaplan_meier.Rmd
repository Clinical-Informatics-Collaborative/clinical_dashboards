...
# The first example is analysis the whether there is significant difference in two different drugs with conditions as cancer, the reading data is already extracted as the standard format used for survival analysis 
